                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg text-gray-700 mb-6">
                            Founded in 2023, RentHub began with a simple idea: technology should be accessible to everyone, regardless of budget. Our founders, tech enthusiasts themselves, recognized the financial
